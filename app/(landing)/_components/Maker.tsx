        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
          ...
          <div className="flex flex-col gap-8">
            ...
            >
              Built by
              <br />
              <span className="italic text-primary">Mohammed.</span>
            </motion.h2>
            ...
            <motion.p
              ...
              style={{ lineHeight: "2" }}
            >
              I build tools that solve real problems for real people. Waraq
              started as a way to keep my own reading and documents organized
              — and grew into a full-stack application I'm proud to share.
            </motion.p>
            ...
            >
              ...
              >
                <Github className="h-4 w-4 transition-colors duration-200 group-hover:text-primary" />
          ...
          >
            ...
            <div className="rounded-sm border border-border bg-background p-8">
              ...
              >
                &ldquo;Good software isn&apos;t just written.
                <br />It&apos;s cared for.&rdquo;
              </blockquote>
              <div className="mt-8 flex items-center gap-3">
                <div className="h-px w-6 bg-primary/50" />
                <span className="text-xs uppercase tracking-[0.15em] text-muted-foreground">
                  Mohammed Ait Sidi Bah — creator of Waraq
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {["Full-Stack Development", "Clean Architecture", "Continuous Learning"].map((tag) => (
                <span
                  key={tag}
